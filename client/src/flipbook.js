...
obtain(['µ/utilities.js'], function ({ zeroPad }) {
  if (!customElements.get('flip-book')) {
    // create a custom element from the canvas element
    class FlipBook extends HTMLCanvasElement {
      constructor() {
        console.log('flipbook create');
    ...
    customElements.define('flip-book', FlipBook, { extends: 'canvas' });
  }

  exports.Flipbook = customElements.get('flip-book');
